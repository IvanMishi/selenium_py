...
# Ссылка на страницу
link = 'https://parsinger.ru/selenium/9/9.1.1/index.html'
...
with webdriver.Chrome() as webdriver:
    ...
    for btn in webdriver.find_elements(By.TAG_NAME,'button'):
    # Ожидает 5 сек кликабельности кнопки на странице
        WebDriverWait(webdriver, 50).until(EC.element_to_be_clickable((btn))).click()
    print(f'Ответ: {webdriver.find_element(By.ID, 'message').text.split(":")[1].strip()}')
    time.sleep(3)
