...
with webdriver.Chrome() as webdriver:  # Создаёт экземпляр драйвера Chrome и автоматически закрывает его по завершении блока кода.
    ...
    list_div = webdriver.find_elements(By.CSS_SELECTOR, "div.text")
    # Перебирает  каждый div
    for i, div in enumerate(list_div):
        # Получает первый и третий теги <p> внутри каждого div
        first_p = div.find_element(By.CSS_SELECTOR, 'p:nth-of-type(1)')
        third_p = div.find_element(By.CSS_SELECTOR, 'p:nth-of-type(3)')
