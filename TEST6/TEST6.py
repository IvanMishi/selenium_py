...
try:
    ...
    x_element = driiver.find_element(By.CSS_SELECTOR, "[class='form-group'] .nowrap:nth-child(2)").text
    ...
    input_area = driiver.find_element(By.CSS_SELECTOR, 'div.container div.form-group input.form-control').send_keys(y)
    ...
    checkbox = driiver.find_element(By.CSS_SELECTOR, "div.form-check [type='checkbox']").click()
    ...
    radio_button = driiver.find_element(By.CSS_SELECTOR, "[name='ruler'][value='robots']").click()
    ...
    button_submit = driiver.find_element(By.CSS_SELECTOR, "form > [type='submit']").click()

# получает alert на веб-странице
    alert = driiver.switch_to.alert
