...
try:
    ...
    input1 = browser.find_element(By.CSS_SELECTOR, 'div.container div.form-group input.form-control').send_keys(y)
    ...
    check1 = browser.find_element(By.CSS_SELECTOR, "div.form-check [type='checkbox']").click()
    ...
    radio1 = browser.find_element(By.CSS_SELECTOR, "[name='ruler'][value='robots']").click()
    ...
    button1 = browser.find_element(By.CSS_SELECTOR, "form > [type='submit']").click()
