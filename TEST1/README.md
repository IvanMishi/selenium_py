...
- Создать переменную с ожидаемым результатом
- Заполняет форму тестовыми данными - в данном случае словом 'Текст'
- Ищет кнопку, предназначенную для отправки данных
- Нажимает на кнопку
- Видит  модальное окно, сохраняет из него текст в переменную, закрывает модальное окно
- Закрывает браузер
- Убеждается, что полученный результат совпадает с ожидаемым
